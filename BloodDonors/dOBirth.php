...
<html>
    <head >
        <meta charset="utf-8">
        <script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.15959" type="text/javascript"></script>
        <link href="https://cdn.jotfor.ms/static/formCss.css?3.3.15959" rel="stylesheet" type="text/css" />
    </head>
    <body>    
        <div class="dOBirth-box"> 
            <div class="label">Datum narození:</div>
            <span class="dateBox"> 
